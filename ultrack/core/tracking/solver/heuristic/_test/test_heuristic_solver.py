...
# TODO: create fixture? this test is a copy of gurobi's test
...
def test_heuristic_solver(config_instance: MainConfig) -> None:
    """
    ...
    """
    solver = HeuristicSolver(config_instance.tracking_config)
