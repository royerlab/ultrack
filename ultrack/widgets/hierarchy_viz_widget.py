...
from magicgui.widgets import CheckBox, FloatSlider, PushButton, Container
...
class HierarchyVizWidget(Container):
    def __init__(self, 
        ...
        self._area_threshold_w = FloatSlider(label="Area", min=0, max=0)
    ...
    def _slider_update(self, value: float) -> None:
        # print('updated slider:',value)
        self.ultrack_layer.volume = value
