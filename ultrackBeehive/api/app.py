...
import ultrackBeehive
from ultrackBeehive import link, segment, solve, to_tracks_layer, tracks_to_zarr
from ultrackBeehive.api.database import (
    Experiment,
    ExperimentStatus,
...
from ultrackBeehive.api.settings import settings
from ultrackBeehive.api.utils.api import UltrackWebsocketLogger, raise_error
from ultrackBeehive.api.utils.fs import open_image
from ultrackBeehive.api.utils.zarr import get_channels_from_ome_zarr
from ultrackBeehive.config import MainConfig
from ultrackBeehive.core.export import tracks_layer_to_networkx, tracks_layer_to_trackmate
from ultrackBeehive.imgproc import detect_foreground, robust_invert
from ultrackBeehive.utils import labels_to_contours
from ultrackBeehive.utils.array import array_apply, create_zarr
from ultrackBeehive.utils.cuda import on_gpu
...
async def root() -> Dict[str, str]:
    ...
    """
    return {"ultrack.__version__": ultrackBeehive.__version__}
