...
from ultrackBeehive import MainConfig, export_tracks_by_extension
from ultrackBeehive.widgets.ultrackwidget.components.button_workflow_config import (
    ButtonWorkflowConfig,
)
from ultrackBeehive.widgets.ultrackwidget.components.emitting_stream import EmittingStream
from ultrackBeehive.widgets.ultrackwidget.data_forms import DataForms
from ultrackBeehive.widgets.ultrackwidget.utils import UltrackInput
from ultrackBeehive.widgets.ultrackwidget.workflows import (
    UltrackWorkflow,
    WorkflowChoice,
    WorkflowStage,
)
...
class UltrackWidget(QWidget):
    ...
    def find_ultrack_widget(viewer: napari.Viewer) -> Optional["UltrackWidget"]:
        """Find and returns Ultrack widget. If widget not found, returns None"""
